...
/**
* The DA class implements the State Pattern for the Data Analytics 
* courses. It takes in a course name and does the proper
* checks to see if the course can be added to the schedule.
* @author Justin Wang
*/
public class DA implements CoursePlannerStateI {
	private String takenCourses = ""; // List of taken courses
	private String courseList = "MNOP"; // Available courses
