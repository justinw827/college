...
/**
* The DSA class implements the State Pattern for the Data Structures 
* and Algorithms courses. It takes in a course name and does the proper
* checks to see if the course can be added to the schedule.
* @author Justin Wang
*/
public class DSA implements CoursePlannerStateI {
	private String takenCourses = ""; // List of taken courses
	private String courseList = "EFGH"; // Available courses
